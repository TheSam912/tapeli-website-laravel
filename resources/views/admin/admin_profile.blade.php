                            ...
                            <div class="align-items-center">
                                <div class="d-flex align-items-center">
                                    ...
                                    <div class="overflow-hidden ms-4">
                                        ...
                                        <p class="my-1 text fs-16">Email: {{ $profileData->email }}</p>
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-6">
                                                    <div class="card border">
                                                        <div class="card-body">
                                                            <h4 class="m-0 fw-semibold text-dark fs-16">Algorithm Developing
                                                            </h4>
                                                            <div class="row mt-2 d-flex align-items-center">
                                                                <div class="col">
                                        ...
                                        <div class="col-md-6 col-sm-6 col-md-6 mb-0">
                                            ...
                                            <div class="row align-items-center g-0 mt-3">
                                                <div class="col-sm-3">
                                                    <p class="text-truncate mt-1 mb-0"><i
                                                            class="mdi mdi-circle-medium text-primary me-2"></i> illustrator
                                                    </p>
                                                </div>
                                                <div class="col-sm-9">
                                                    <div class="progress mt-1" style="height: 8px;">
                                                    ...
                                                    <li class="profile-item">
                                                        ...
                                                        <div class="exper-item-list">
                                                            <div>
                                                                ...
                                                                <p class="mb-0">Lead and grew the sketch product management
                                                                    team. Managed teams across Menio Park, Denver, New York
                                                                    and Remote offices.</p>
                                                            </div>
                                                        </div>
                                                    </li>
                                                ...
                                                <div class="card border mb-0">
                                                    ...
                                                    <div class="card-header">
                                                        <div class="row align-items-center">
                                                            <div class="col">
                                                                <h4 class="card-title mb-0">Personal Information
                                                                </h4>
                                                            </div><!--end col-->
                                                        </div>
                                                    </div>
                                                            ...
                                                            <div class="form-group mb-3 row">
                                                                ...
                                                                <div class="col-lg-12 col-xl-12">
                                                                    <input class="form-control" type="file" name="photo"
                                                                        id="image" value="{{ $profileData->photo }}">
                                                                </div>
                                                            </div>
                                                            <div class="form-group mb-3 row">
