        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-header">
                    <h5 class="card-title mb-0">My Usability</h5>
                </div><!-- end card header -->
                                ...
                                <table id="datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                colspan="1" style="width: 340px;"
                                                aria-label="Position: activate to sort column ascending">Youtube Link</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                colspan="1" style="width: 340px;"
                                                aria-label="Position: activate to sort column ascending">Link</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                    ...
                                    <tbody>
                                        @foreach ($usability as $key => $item)
                                            <tr>
                                                ...
                                                <td>{{ $item->link }}</td>
                                                <td>
                                                    <a href="{{ route('edit.usability', $item->id) }}"
                                                        class="btn btn-success btn-sm">Edit</a>
                                                    <a href="{{ route('delete.usability', $item->id) }}"
