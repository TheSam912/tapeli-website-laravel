                                ...
                                <table id="datatable"
                                    ...
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable"
                                                rowspan="1" colspan="1" style="width: 192px;" aria-sort="ascending"
                                                aria-label="Name: activate to sort column descending">Image Cover</th>
                                            <th class="sorting sorting_asc" tabindex="0" aria-controls="datatable"
                                                rowspan="1" colspan="1" style="width: 192px;" aria-sort="ascending"
                                            ...
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                ...
                                                aria-label="Position: activate to sort column ascending">Author</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                                colspan="1" style="width: 340px;"
                                                aria-label="Position: activate to sort column ascending">Read Time</th>
                                            <th class="sorting" tabindex="0" aria-controls="datatable" rowspan="1"
                                    ...
                                    <tbody>
                                        @foreach ($posts as $key => $item)
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{{ route('edit.posts', $item->id) }}"
